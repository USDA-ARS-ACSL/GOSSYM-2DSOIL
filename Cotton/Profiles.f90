...
1080 Format(/ 4X,'Plant Maps......... ',A14,6X,'PGR & Herbicides... ',A15/)

    OPEN(11,FILE=profile,FORM=FILFRM,STATUS='OLD',ERR=570)
    !READ(11,*,ERR=580,END=600) PRFNAM,PDESCP,rundate,EMERG,ISKWTH
    !Emerge is read from Soil
    READ(11,*,ERR=580,END=600) PRFNAM,PDESCP,rundate,ISKWTH
    ...
    ELSE
        ...
        WRITE(LSTNG,1060) VARITY(IVARTY),imostr,idystr,iyrstr, &
        ...
        WRITE(LSTNG,1080) pmafle, pgrfle
    ENDIF
    RETURN
570 CONTINUE
