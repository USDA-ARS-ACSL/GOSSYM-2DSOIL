...
//For cotton: Yao, H., Zhang, Y., Yi, X., Zhang, X., Fan, D., Chow, W.S., & Zhang, W. (2018).Diaheliotropic leaf 
//movement enhances leaf photosynthetic capacityand photosynthetic lightand nitrogen use efficiency via 
//optimising nitrogen partitioning among photosynthetic components in cotton(Gossypium hirsutum L.).Plant Biology, 20(2), 213 - 222.
CRadTrans::CRadTrans()
{
	LeafAngle = Diaheliotropic; 
	LeafAngleFactor = 1.5; // for spherical leaves
